...
from neuronlp2.io.reader import CoNLLUReader, CoNLLUReaderModified
...
def read_data(source_path, word_alphabet: Alphabet, char_alphabet: Alphabet, pos_alphabet: Alphabet, type_alphabet: Alphabet,
    ...
    reader = CoNLLUReaderModified([source_path], word_alphabet, char_alphabet, pos_alphabet, type_alphabet)
