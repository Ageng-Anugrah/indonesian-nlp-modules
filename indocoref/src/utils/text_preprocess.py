...
from .feature_utils import CLITICS
...
class TextPreprocessModified:
    def __init__(self, annotated, pkl_dir):
    ...
    def run(self, log_step=10):
        ...
        annotation, sents = FileUtils.read_annotated_file_modified(self.annotated, name)
